      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[0.95fr_1.35fr] lg:px-8">
        ...
        <Card className="p-5" id="onboarding">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <label className="space-y-1 text-sm font-medium">Email (weekly digest)<Input type="email" value={profile.email} placeholder="Optional" onChange={(event) => setProfile((current) => ({ ...current, email: event.target.value }))} /></label>
          </div>
