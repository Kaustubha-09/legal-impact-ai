...
RIGHTS_TOPICS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": "Notice requirements, court filing, just-cause protections, and tenant defenses in eviction proceedings.",
        "laws": ["State landlord-tenant codes", "Local just-cause eviction ordinances"],
        "cases": [],
        "questions": ["How much notice does my landlord have to give before eviction?", "Can I be evicted without going to court?"],
        "state_notes": "Notice periods, permitted eviction reasons, and court procedures vary significantly by state and city.",
    },
    {
        "name": "Workplace safety",
        "summary": "Hazard protections, injury reporting, retaliation for safety complaints, and employer recordkeeping duties.",
        "laws": ["Occupational Safety and Health Act", "OSHA General Duty Clause"],
        "cases": [],
        "questions": ["Can I refuse unsafe work?", "Can I be fired for reporting a safety hazard?"],
        "state_notes": "Some states run their own OSHA-approved workplace safety programs with additional protections.",
    },
    {
        "name": "Criminal record relief",
        "summary": "Expungement, record sealing, and fair-chance hiring protections for people with a criminal record.",
        "laws": ["State expungement statutes", "Fair Chance Act"],
        "cases": [],
        "questions": ["Can I get my record expunged?", "Can an employer ask about my criminal history?"],
        "state_notes": "Eligibility for expungement or sealing and fair-chance hiring timing rules vary widely by state.",
    },
    {
        "name": "Debt and bankruptcy",
        "summary": "Wage garnishment limits, bankruptcy filing basics, and protections from aggressive debt collection.",
        "laws": ["Bankruptcy Code (Title 11)", "Consumer Credit Protection Act"],
        "cases": [],
        "questions": ["Can my wages be garnished for a debt?", "What happens to my debts if I file for bankruptcy?"],
        "state_notes": "State exemption laws determine how much property and income are protected during bankruptcy.",
    },
    {
        "name": "Traffic and licensing",
        "summary": "Traffic stops, license suspension, and the process for contesting citations.",
        "laws": ["State vehicle codes", "State DMV administrative rules"],
        "cases": [],
        "questions": ["Can my license be suspended without a hearing?", "How do I contest a traffic ticket?"],
        "state_notes": "License suspension procedures and ticket-contest deadlines are set entirely at the state level.",
    },
    {
        "name": "Small claims court",
        "summary": "Filing a small claims case, dollar limits, and what to expect without a lawyer.",
        "laws": ["State small claims court rules"],
        "cases": [],
        "questions": ["How much can I sue for in small claims court?", "Do I need a lawyer for small claims?"],
        "state_notes": "Dollar limits, filing fees, and whether lawyers are allowed vary by state.",
    },
    {
        "name": "Wage and overtime disputes",
        "summary": "Unpaid wages, overtime eligibility, meal and rest breaks, and how to file a wage claim.",
        "laws": ["Fair Labor Standards Act", "State wage and hour laws"],
        "cases": [],
        "questions": ["Am I owed overtime?", "How do I file a claim for unpaid wages?"],
        "state_notes": "Many states set overtime thresholds and break requirements stricter than federal law.",
    },
    {
        "name": "Public benefits",
        "summary": "Unemployment insurance, SNAP, and disability benefit eligibility, applications, and appeals.",
        "laws": ["Social Security Act", "State unemployment insurance codes"],
        "cases": [],
        "questions": ["Why was my unemployment claim denied?", "How do I appeal a benefits decision?"],
        "state_notes": "Unemployment eligibility rules and benefit amounts are set and administered by each state.",
    },
]
...
LEGAL_DOCUMENTS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "summary": "Requires employers to provide a workplace free from recognized hazards likely to cause death or serious physical harm.",
    },
    {
        "title": "Bankruptcy Code Chapter 7",
        "type": "Federal statute",
        "jurisdiction": "Federal",
        "date": "Current",
        "category": "Debt and bankruptcy",
        "summary": "Provides for liquidation of a debtor's non-exempt assets to discharge most unsecured debts.",
    },
    {
        ...
        "date": "Current",
        "category": "Consumer rights",
        "summary": "Requires lenders to disclose credit terms and costs, including annual percentage rate, before a consumer is bound to a loan.",
    },
    {
        ...
        "summary": "Police must inform suspects of their right to remain silent and to an attorney before custodial interrogation.",
    },
    {
        ...
        "date": "1963-03-18",
        "category": "Constitutional rights",
        "summary": "States must provide a defense attorney to criminal defendants who cannot afford one.",
    },
    {
        ...
        "jurisdiction": "Federal",
        "date": "Current",
        "category": "Criminal record relief",
        "summary": "Generally prohibits federal agencies and contractors from asking about criminal history before a conditional job offer.",
    },
]
